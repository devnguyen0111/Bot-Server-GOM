...
module.exports = {
	...
	run: async (client, interaction) => {
		...
		let row = new MessageActionRow().addComponents(
			new MessageButton().setURL(`https://discord.com/api/oauth2/authorize?client_id=${client?.user?.id}&permissions=1644971949559&scope=bot%20applications.commands`).setLabel("Invite Patrick-Bot").setStyle("LINK"),

			new MessageButton().setURL(`https://discord.gg/QcKuDwkZ8X`).setLabel("Support Server").setStyle("LINK")
		);
